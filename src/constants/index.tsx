...
const SIXTH_THANK_YOU_PARAGRAPH =
  "This will be used in the event you need to reset your password.";
...
export default {
  ...
  FOURTH_THANK_YOU_PARAGRAPH,
  FIFTH_THANK_YOU_PARAGRAPH,
  SIXTH_THANK_YOU_PARAGRAPH,
  USER_AGREEMENT,
